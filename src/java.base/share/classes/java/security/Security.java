 ...
 *           throw an unspecified error when initializing the {@code Security}
 *           class.
 *
...
public final class Security {
  ...
  private static final String SYS_PROP_SWITCH = "java.security.disableSystemPropertiesFile";
  private static final String SEC_PROP_SWITCH = "security.useSystemPropertiesFile";
   ...
   *                              method
   *                              denies
   *                              access to retrieve the specified security
   *                              property value
   ...
   *                    service (e.g., Signature, MessageDigest, Cipher, Mac,
   *                    KeyStore).
